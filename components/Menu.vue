<template>
  <div class="main-menu" :class="{ hidden: isHidden }">
    ...
    <div class="contact-info">
      ...
      <a class="text-3xl mt-7 block" href="tel:663568828"
        >663 568 828 <span>Zadzwoń do mnie</span>
      </a>
    </div>
  </div>
</template>
...
.contact-info {
  @apply flex-col items-center lg:items-center justify-center w-full xl:w-1/3 p-10 md:p-12 hidden xl:flex xl:h-full text-white xl:items-center;
}
